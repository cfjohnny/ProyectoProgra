 ...
 * @author Ariana
 */
public class Ovejas extends javax.swing.JFrame {
    ...
    public void cargarDatos() {
        ...
        if (txtBuscar.getText().contentEquals("")) {
            animales = datosAnimales.listaAnimalesPorEspecie("Ovejas");
        } else {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("APADRINA UNA OVEJA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ovejas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
