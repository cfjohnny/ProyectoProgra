 ...
 * @author Ariana
 */
public class Burros extends javax.swing.JFrame {
    ...
    public void cargarDatos() {
        ...
        if (txtBuscar.getText().contentEquals("")) {
            animales = datosAnimales.listaAnimalesPorEspecie("Burros");
        } else {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("APADRINAR UN BURRO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Burros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
