 ...
 * @author Ariana
 */
public class Conejos extends javax.swing.JFrame {
    ...
    public void cargarDatos() {
        ...
        if (txtBuscar.getText().contentEquals("")) {
            animales = datosAnimales.listaAnimalesPorEspecie("Conejos");
        } else {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("APADRINAR UN CONEJO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Conejos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
