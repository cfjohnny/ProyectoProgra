 ...
 * @author Ariana
 */
public class Cabras extends javax.swing.JFrame {
    ...
    public void cargarDatos() {
        ...
        if (txtBuscar.getText().contentEquals("")) {
            animales = datosAnimales.listaAnimalesPorEspecie("Cabras");
        } else {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("APADRINAR UNA CABRA");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cabras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
