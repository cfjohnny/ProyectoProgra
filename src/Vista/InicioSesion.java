    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        if (Main.empleados.isEmpty()) {
            ...
            for (int i = 0; i < Main.empleados.size(); i++) {
                if (txtUsuario.getText().equals(Main.empleados.get(i).getIdEmpleado()) && String.valueOf(pwdContrasenna.getPassword()).equals(Main.empleados.get(i).getContrasena())) {
                    Main.usuarioLogueado = Main.empleados.get(i).getNombre();
                    existe = true;
                    break;
                } else if (!txtUsuario.getText().equals(Main.empleados.get(i).getIdEmpleado())
                        || !String.valueOf(pwdContrasenna.getPassword()).equals(Main.empleados.get(i).getContrasena())) {
                    existe = false;
                }
            }
            if (existe == false) {
